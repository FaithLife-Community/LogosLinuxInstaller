...
LOGOS_SCRIPT_VERSION = "4.0.0-alpha.2"
MYDOWNLOADS = None
PASSIVE = None
...
LOGOS_WHITE = '#FCFCFC'
VERBUM_PATH = None
RECOMMENDED_WINE64_APPIMAGE_FILENAME = os.path.basename(RECOMMENDED_WINE64_APPIMAGE_FULL_URL).split(".AppImage")[0]
RECOMMENDED_WINE64_APPIMAGE_FULL_VERSION = "v8.19-devel"
RECOMMENDED_WINE64_APPIMAGE_URL = RECOMMENDED_WINE64_APPIMAGE_FULL_URL
RECOMMENDED_WINE64_APPIMAGE_VERSION = RECOMMENDED_WINE64_APPIMAGE_FULL_VERSION
